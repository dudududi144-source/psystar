...
**התקן מוזיקלי פסיכודלי מקצה לקצה — לב קצב, סינתזה, הרמוניה, מסע ויזואלי, רשת משפחתית, גשרים בין עולמות, נהגים אמיתיים, זיכרון, ספריית חלומות, מקדש נייד, מגע חי ונשימה אנושית במערכת קנונית אחת**
...
![phases](https://img.shields.io/badge/phases-13%2F13-ffd166?style=for-the-badge)
...
**PSYSTAR — לא מכשיר. שער. צומת. כלי. זיכרון. ספרייה. מקדש. מכונה שמקשיבה. גשר בין עולמות. מכונה שמרגישה. ומכונה שמבינה מוזיקה.**
