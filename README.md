...
![phases](https://img.shields.io/badge/phases-19%2F19-ffd166?style=for-the-badge)
...
**PSYSTAR — לא מכשיר. שער. צומת. כלי. זיכרון. ספרייה. מקדש. מכונה שמקשיבה. גשר בין עולמות. מכונה שמרגישה. מכונה שמבינה מוזיקה. מכונה שמספרת סיפורים שלמים. משפחה שמחליפה עולמות. רשת שלוחשת ושואגת. ומכונה שמנגנת מחשבות.**
