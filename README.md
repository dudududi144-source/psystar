...
יצוא מסע: בחרו מספר תיבות ולחצו **עיבוד והורדה ⬇** — המכונה מרנדרת את התבנית אופליין עם כל השכבות (מגילה, הרמוניה, עוצמות, אקסנטים, נשיחה... נשימה) ומוציאה psystar-journey.wav שאפשר לקחת לכל מקום.
