...
**התקן מוזיקלי פסיכודלי מקצה לקצה — לב קצב, סינתזה, מסע ויזואלי, רשת משפחתית, גשרים בין עולמות, נהגים אמיתיים, זיכרון, ספריית חלומות, מקדש נייד, מגע חי ונשימה אנושית במערכת קנונית אחת**
...
![phases](https://img.shields.io/badge/phases-12%2F12-ffd166?style=for-the-badge)
...
- **Domain** — המודל המוזיקלי: תבניות, תחבורה, התקנים, סצנות, שירים, קצב אוקלידי, פריסטים, יומני מסע, ספריות, אקסנטים.
...
- **UI** — המסע: קונסולת DMT חיה, נגינה חיה, מגע חי, נשימה אנושית, ומקדש PWA נייד.
...
- **נשימה אנושית: סחיפת זמן, jitter עוצמה, הערות רפאים, אקסנטים בזהב (Shift+קליק)**
...
נשימה אנושית: סמנו **Shift+קליק** על צעדים כדי להדליק אקסנט זהב, והרימו את **נשימה אנושית** כדי שהמכונה תתחיל לאלתר — סחיפות זמן, תנודות עוצמה, והערות רפאים עדינות.

## ✦ מבנה

- `docs/` — ארכיטקטורה, roast, החלטות, בדיקות, עיצוב, אינטגרציה, מפת דרכים
- `src/` — core · domain · protocol · engine · integration · ui
- `tests/` — unit · domain · protocol · engine · integration · drivers · journey · library · pwa · touch · p2p · human
...
**PSYSTAR — לא מכשיר. שער. צומת. כלי. זיכרון. ספרייה. מקדש. מכונה שמקשיבה. גשר בין עולמות. ומכונה שמרגישה.**
